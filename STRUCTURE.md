...
│   └── skills/
│       ├── ux-audit.md              # Comprehensive cognitive UX audit skill
│       └── ux-review.md             # Quick UX review skill
...
```
~/.claude/skills/
├── ux-audit.md       ← Copy from .claude/skills/
└── ux-review.md      ← Copy from .claude/skills/
```
...
1. **New skill**: Add `.md` file to `.claude/skills/`
2. **Update**: `package.json` → `claudeCode.skills` array
3. **Document**: Add usage examples to `EXAMPLES.md`
4. **Announce**: Update `README.md` with new capability
...
4. **Use**: Type `/ux-audit` or `/ux-review` in Claude Code
